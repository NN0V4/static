/*! For license information please see main.aed277d9.js.LICENSE.txt */
(() => {
  "use strict";
  var e = {
      730: (e, n, t) => {
        ...
        function Ho(e, n, t) {
          return 0 === (21 & ao)
            ? (e.baseState && ((e.baseState = !1), (bu = !0)),
              (e.memoizedState = t))
            : (ur(t, n) ||
                ((t = gn()), (oo.lanes |= t), (Di |= t), (e.baseState = !0)),
              n);
        }
        function Wo(e, n) {
          var t = kn;
        ...
        var lu = {
          ...
          enqueueSetState: function (e, n, t) {
            ...
            (a.payload = n),
              ...
              null !== (n = ja(e, a, l)) && (ts(n, e, l, r), Va(n, e, l));
          },
          ...
          enqueueForceUpdate: function (e, n) {
            ...
            (l.tag = 2),
              ...
              null !== (n = ja(e, l, r)) && (ts(n, e, r, t), Va(n, e, r));
          },
        };
        ...
        function as(e, n) {
          ...
          return (
            ...
            2 !== (e = gs(e, n)) && ((n = Vi), (Vi = t), null !== n && os(n)),
            e
          );
        }
        function os(e) {
        ...
        function gs(e, n) {
          ...
          if ((Ca(), (Pi = t), (_i.current = r), null !== Ti))
            throw Error(a(261));
        ...
        function $s(e, n, t, r, l, a, o, u, i) {
          return (
            ((e = Vs(t, r, !0, e, 0, a, 0, u, i)).context = As(null)),
            (t = e.current),
        ...
        function Bs(e, n, t, r) {
          ...
          return (
            ...
            null !== (e = ja(l, n, o)) && (ts(e, l, o, a), Va(e, l, o)),
            o
          );
        }
        function Hs(e) {
  ...
  const o = () => {
    ...
    return (0, a.jsxs)("div", {
      ...
      children: [
        (0, a.jsx)("h2", { children: "Log In" }),
        (0, a.jsxs)("p", {
          className: "options",
          children: [
            "Don't have an account? ",
            (0, a.jsx)("a", { href: signupUrl, children: "Sign Up" }),
          ],
        }),
        i &&
          (0, a.jsx)("div", { className: "alert alert-danger", children: i }),
        c &&
          (0, a.jsx)("div", { className: "alert alert-success", children: c }),
        (0, a.jsx)("br", {}),
        (0, a.jsxs)("form", {
          ...
          onSubmit: async (n) => {
              ...
              if (document.cookie && "" !== document.cookie) {
                ...
                for (let r = 0; r < t.length; r++) {
                  ...
                  if (l.substring(0, e.length + 1) === e + "=") {
                    n = decodeURIComponent(l.substring(e.length + 1));
                    break;
                  }
                }
              }
            ...
            try {
              ...
              const n = await fetch(
                  "http://127.0.0.1:8000/profiles/api/login/",
                  {
                    method: "POST",
                    headers: {
                ...
                l = await n.json();
              n.ok
                ? (console.log("Login successful:", l),
                  f(l.message || "Login successful!"),
                  s(null),
                  l.token &&
                    (console.log("Token found:", l.token),
                    localStorage.setItem("token", l.token)),
                  (window.location.href = "/challenges"))
                : (console.error("Error Response:", l),
                  s(l.error || "Login failed."),
                  f(null));
            } catch (l) {
              console.error("Error during login:", l),
                s("An unexpected error occurred. Please try again."),
                f(null);
            } finally {
              p(!1);
            }
          ...
          children: [
            ...
            (0, a.jsxs)("div", {
              ...
              children: [
                ...
                (0, a.jsx)("span", {
                  className: "eye-icon form-control-span input-group-text",
                  onClick: () => {
                    u(!o);
                  },
                  style: { cursor: "pointer" },
                  children: (0, a.jsx)("i", {
                    className: "bi " + (o ? "bi-eye" : "bi-eye-slash"),
                    style: { fontSize: "1rem" },
                  }),
                }),
              ],
  ...
  l.createRoot(document.getElementById("root")).render(
    (0, a.jsx)(r.StrictMode, { children: (0, a.jsx)(u, {}) })
  );
})();
//# sourceMappingURL=main.aed277d9.js.map
